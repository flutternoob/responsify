...
class ResponsiveUiWidget extends StatefulWidget {
  ...
  final Widget Function(
      BuildContext context, DeviceInformation deviceInformation)? builder;
  ...
  const ResponsiveUiWidget(
      {Key? key, this.builder, required this.targetOlderComputers})
      : super(key: key);
...
class _ResponsiveUiWidgetState extends State<ResponsiveUiWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) => setState(
        () => localWidgetWidth = responsiveKey.currentContext!.size!.width));
    WidgetsBinding.instance!.addPostFrameCallback((_) => setState(
        () => localWidgetHeight = responsiveKey.currentContext!.size!.height));
  }
        ...
        builder: (context, boxConstraints) {
          ...
          DeviceInformation deviceInformation = DeviceInformation(
            ...
            deviceTypeInformation: determineDeviceType(
                mediaQueryData, widget.targetOlderComputers),
